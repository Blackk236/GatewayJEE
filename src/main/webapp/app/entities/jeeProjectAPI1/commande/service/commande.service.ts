...
export class CommandeService {
  public resourceUrl = this.applicationConfigService.getEndpointFor('api/commandes', 'jeeprojectapi1');
  ...
  protected convertDateFromClient(commande: ICommande): ICommande {
    return Object.assign({}, commande, {
      date: commande.date?.isValid() ? commande.date.format(DATE_FORMAT) : undefined,
    });
  }
