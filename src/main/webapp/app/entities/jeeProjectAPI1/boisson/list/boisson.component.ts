...
export class BoissonComponent implements OnInit {
  ...
  trackId(index: number, item: IBoisson): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IBoisson[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
